 ...
 public class Magma implements org.bukkit.event.Listener
 {
   ...
   public void onPlayerMove(PlayerMoveEvent event1) {
     ...
     if ((KitAPI.getKit(player11) == "Magma'") && (
       ...
       player11.addPotionEffect(new org.bukkit.potion.PotionEffect(org.bukkit.potion.PotionEffectType.POISON, 65, 0));
       player11.addPotionEffect(new org.bukkit.potion.PotionEffect(org.bukkit.potion.PotionEffectType.SLOW, 65, 0));
     }
   }
