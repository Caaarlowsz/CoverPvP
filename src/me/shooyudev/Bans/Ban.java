		...
		if (cmd.getName().equalsIgnoreCase("ban")) {
			...
			if (vitima == null) {
				...
				if (vitimaoff.getName() == jogador.getName()) {
					API.sendMsg(jogador, Strings.servidormensagem + ChatColor.GRAY
							+ "Voce nao pode usar esse comando em vc mesmo !");
					API.sendSound(jogador, Sound.NOTE_PLING, 10);
					return true;
				}
				if (vitimaoff.getName().equals("TranquilliYT")) {
					API.sendMsg(jogador, Strings.servidormensagem + ChatColor.GRAY + "Você esta bloqueado de banir o "
				...
				if (Config.getConfig().getBans().get("Bans." + vitimaoff.getUniqueId()) != null) {
					API.sendMsg(jogador,
							Strings.servidormensagem + ChatColor.GRAY + "O jogador " + ChatColor.YELLOW + ChatColor.BOLD
									+ vitimaoff.getName() + ChatColor.GRAY + " Já está " + ChatColor.DARK_RED
									+ ChatColor.BOLD + "PERMANENTEMENTE" + ChatColor.GRAY + " Banido !");
					API.sendSound(jogador, Sound.NOTE_PLING, 10);
					return true;
				}
				if (Config.getConfig().getIpBans().get("IPBans." + vitimaoff.getUniqueId()) != null) {
					API.sendMsg(jogador,
							Strings.servidormensagem + ChatColor.GRAY + "O jogador " + ChatColor.YELLOW + ChatColor.BOLD
									+ vitimaoff.getName() + ChatColor.GRAY + " Já está " + ChatColor.DARK_RED
									+ ChatColor.BOLD + "PERMANENTEMENTE" + ChatColor.GRAY + " Banido pelo seu IP!");
					API.sendSound(jogador, Sound.NOTE_PLING, 10);
					return true;
				}
				String Motivo = "";
				...
				API.sendBC(ChatColor.GRAY + "O Staff " + ChatColor.YELLOW + ChatColor.BOLD + jogador.getName()
						+ ChatColor.GRAY + " baniu " + ChatColor.DARK_RED + ChatColor.BOLD + "PERMANENTEMENTE"
						+ ChatColor.GRAY + " O jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitimaoff.getName()
						+ ChatColor.GRAY + ". Motivo: " + ChatColor.GOLD + ChatColor.BOLD + Motivo);
				API.sendMsg(jogador,
						ChatColor.GRAY + "Você baniu o jogador " + ChatColor.YELLOW + ChatColor.BOLD
								+ vitimaoff.getName() + ChatColor.DARK_RED + ChatColor.BOLD + "PERMANENTEMENTE"
								+ ChatColor.GRAY + " .");
				API.sendStaff(ChatColor.GRAY + "O Staff " + ChatColor.YELLOW + ChatColor.BOLD + jogador.getName()
						+ ChatColor.GRAY + " baniu o jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitimaoff.getName()
			...
			double l = Config.getConfig().getBans().getDouble("Players Banidos");
			API.sendMsg(jogador,
					ChatColor.GRAY + "Você baniu o jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitima.getName()
							+ ChatColor.DARK_RED + ChatColor.BOLD + "PERMANENTEMENTE" + ChatColor.GRAY + " .");
			API.sendBC(ChatColor.GRAY + "O Staff " + ChatColor.YELLOW + ChatColor.BOLD + jogador.getName()
					+ ChatColor.GRAY + " baniu " + ChatColor.DARK_RED + ChatColor.BOLD + "PERMANENTEMENTE"
					+ ChatColor.GRAY + " O jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitima.getName()
					+ ChatColor.GRAY + ". Motivo: " + ChatColor.YELLOW + ChatColor.BOLD + Motivo);
			API.sendStaff(ChatColor.GRAY + "O Staff " + ChatColor.YELLOW + ChatColor.BOLD + jogador.getName()
					+ ChatColor.GRAY + " baniu o jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitima.getName()
					+ ChatColor.GRAY + ". Motivo: " + ChatColor.YELLOW + ChatColor.BOLD + Motivo);
