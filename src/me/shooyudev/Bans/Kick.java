	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("kick")) {
			...
			if (vitima.getName().equals("TranquilliYT")) {
				API.sendMsg(jogador, Strings.servidormensagem + ChatColor.GRAY + "Você esta bloqueado de Kickar o " + ChatColor.DARK_RED + ChatColor.BOLD + "DONO" + ChatColor.DARK_RED + " TranquilliYT");
				API.sendSound(jogador, Sound.NOTE_PLING, 10);
				return true;
			}
			if (vitima.getName().equals("TranquilliYT")) {
			...
			API.sendMsg(jogador, ChatColor.GRAY + "Você kickou o jogador " + ChatColor.YELLOW + ChatColor.BOLD + vitima.getName() + "§f.");
			API.sendStaff(ChatColor.GRAY + "O Staff " + ChatColor.YELLOW + ChatColor.BOLD + jogador.getName() + ChatColor.GRAY + " kickou o jogador " + ChatColor.GOLD + ChatColor.BOLD + vitima.getName() + ". Motivo: " + ChatColor.GOLD + ChatColor.BOLD + Motivo);
