		...
		if (cmd.getName().equalsIgnoreCase("groupvip")) {
			...
			if (args.length == 2) {
				...
				if (vipgroup.equalsIgnoreCase("vip")) {
					p.sendMessage("");
					p.sendMessage(ChatColor.YELLOW + "O Vip " + ChatColor.GRAY + "[ " + ChatColor.GREEN + ChatColor.BOLD
							+ "VIP" + ChatColor.GRAY + " ] " + ChatColor.YELLOW + "Foi dado ao Jogador "
				...
				if (vipgroup.equalsIgnoreCase("pro")) {
					p.sendMessage("");
					p.sendMessage(ChatColor.YELLOW + "O Vip " + ChatColor.GRAY + "[ " + ChatColor.GOLD + ChatColor.BOLD
							+ "PRO" + ChatColor.GRAY + " ] " + ChatColor.YELLOW + "Foi dado ao Jogador "
							+ jogador.getName() + ChatColor.YELLOW + "[" + jogador.getUniqueId() + "]");
					p.sendMessage("");
					Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
				...
				if (vipgroup.equalsIgnoreCase("mvp")) {
					p.sendMessage("");
					p.sendMessage(ChatColor.YELLOW + "O Vip " + ChatColor.GRAY + "[ " + ChatColor.BLUE + ChatColor.BOLD
							+ "MVP" + ChatColor.GRAY + " ] " + ChatColor.YELLOW + "Foi dado ao Jogador "
							+ jogador.getName() + ChatColor.YELLOW + "[" + jogador.getUniqueId() + "]");
					p.sendMessage("");
					Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
