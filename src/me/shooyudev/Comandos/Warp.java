	...
	public boolean onCommand(CommandSender Sender, Command Cmd, String Label, String[] Args) {
		...
		if(Cmd.getName().equalsIgnoreCase("warp")){
			...
			if(Args[0].equalsIgnoreCase("fps1")){
				...
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp" + ChatColor.YELLOW + ChatColor.GOLD + " FPS Sem Armadura" + ChatColor.WHITE + "!");
             ...
             if(Args[0].equalsIgnoreCase("fps2")){
				...
				p.getInventory().clear();
				p.getInventory().setArmorContents(null);
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp" + ChatColor.YELLOW + ChatColor.GOLD + " FPS Com Armadura" + ChatColor.WHITE + "!");
				Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), new Runnable() {
					public void run() {
			...
			if(Args[0].equalsIgnoreCase("challenge")){
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp " + ChatColor.YELLOW + ChatColor.BOLD + " LAVACHALLENGE " + ChatColor.WHITE + "!");
				p.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 99999,99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 99999 , 99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, 99999 , 99999));
			...
			if(Args[0].equalsIgnoreCase("knockback")){
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp " + ChatColor.YELLOW + ChatColor.BOLD + " KNOCKBACK " + ChatColor.WHITE + "!");
				p.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 99999,99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 99999 , 99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, 99999 , 99999));
			...
			if(Args[0].equalsIgnoreCase("textura")){
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp " + ChatColor.YELLOW + ChatColor.BOLD + " TEXTURA " + ChatColor.WHITE + "!");
				p.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 99999,99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 99999 , 99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, 99999 , 99999));
				...
				Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), new Runnable() {
					public void run() {
						...
						p.getInventory().setItem(13, API.criarItem(p, Material.RED_MUSHROOM, "", new String[] {}, 1, (short)0));
						p.getInventory().setItem(14, API.criarItem(p, Material.BROWN_MUSHROOM, "", new String[] {}, 1, (short)0));
						p.getInventory().setItem(15, API.criarItem(p, Material.BOWL, "", new String[] {}, 1, (short)0));
				            
					}
				}, 3 * 20);
			}
			if(Args[0].equalsIgnoreCase("voidchallenge")){
				p.sendMessage(Strings.servidormensagem + ChatColor.GRAY + "Você está sendo enviado para a warp " + ChatColor.YELLOW + ChatColor.BOLD + " VOIDCHALLENGE " + ChatColor.WHITE + "!");
				p.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 99999,99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.CONFUSION, 99999 , 99999));
				p.addPotionEffect(new PotionEffect(PotionEffectType.BLINDNESS, 99999 , 99999));
