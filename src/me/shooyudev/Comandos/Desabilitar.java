			...
			if (command.getName().equalsIgnoreCase("desabilitar")) {
				...
				if(argumentos[0].equalsIgnoreCase("fullkit")){
					...
					if(!Habilitar.fullkit){
						...
						Bukkit.broadcastMessage(ChatColor.GRAY + "O Beneficio " + ChatColor.GOLD + "[" + ChatColor.YELLOW + ChatColor.BOLD + " FULLKIT " + ChatColor.GOLD + "]" + ChatColor.GRAY + " foi removido para todos !");
