		...
		if(cmd.getName().equalsIgnoreCase("groupset")) {
			...
			if(args.length == 2) {
				...
				if(grupo.equalsIgnoreCase("normal")) {
					p.sendMessage("§7§lO Player " + ChatColor.YELLOW + player.getName()  +  " §7Alterado para Normal");
				...
				if(grupo.equalsIgnoreCase("pro")) {
					...
					Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "pex user " + player.getName() + " group set Pro");
				...
				if(grupo.equalsIgnoreCase("mvp")) {
					...
					Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "pex user " + player.getName() + " group set Mvp");
				...
				if(grupo.equalsIgnoreCase("youtuber")) {
					p.sendMessage("§7§lO Player " + ChatColor.YELLOW + player.getName()  +  " §7Alterado para Youtuber");
				...
				if(grupo.equalsIgnoreCase("builder")) {
					p.sendMessage("§7§lO Player " + ChatColor.YELLOW + player.getName()  +  " §7Alterado para Builder");
				...
				if(grupo.equalsIgnoreCase("helper")) {
					p.sendMessage("§7§lO Player " + ChatColor.YELLOW + player.getName()  +  " §7Alterado para Helper");
				...
				if(grupo.equalsIgnoreCase("gerente")) {
					p.sendMessage("§7§lO Player " + ChatColor.YELLOW + player.getName()  +  " §7Alterado para Gerente");
